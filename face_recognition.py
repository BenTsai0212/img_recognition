...
class Face_recognition:
    ...
    def predict(self, path):
        ...
        '''
        pred_label, min_distance, score = self._img_simiarity_evaluate(path)
        return pred_label, min_distance, score
    ...
    def _emb_distance_evaluate(self, img):
        ...
        if img_cropped == None:
            ...
            img_emb = self.model(img_cropped.unsqueeze(0)).detach().numpy()[0]
    ...
    def _test(self):
        ...
        for target_pth in glob.glob(os.path.join(self.test_pth, '*[.jpg-.jpeg]')):
            ...
            pred_label, min_distance, score = self._img_simiarity_evaluate(target_pth)
